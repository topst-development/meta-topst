...
SUPPORT_MACHINES="ai-g-topst d3-g-topst-main d3-g-topst-sub d5-g-topst-main d5-g-topst-sub"
...
export TEMPLATECONF=$cur_path/poky/meta-topst/template/${machine}
