...
LICENSE = "Imagination"
LIC_FILES_CHKSUM = "file://${THISDIR}/../../licenses/Imagination;md5=f3134b4f9cba437257b9b234736dad4d"
...
# for systemd
SYSTEMD_PACKAGES = "${PN}"
SYSTEMD_SERVICE:${PN} = "pvr-util.service"
...
RDEPENDS:${PN} += "libpvr-telechips libgles2-telechips libegl-telechips"
